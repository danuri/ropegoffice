	...
	<body class="document">
      ...
      <table class="table" width="500px" border="0">
        ...
        <tr>
          ...
          <td colspan="2"><?= $surat->srt_asal?></td>
        </tr>
        <tr>
          <td style="text-align:right;height:20px;"></td>
          <td colspan="2"><?= $surat->srt_asal_perihal?></td>
        </tr>
        <tr>
          <td style="text-align:right;height:25px;"></td>
          <td colspan="2"><?= $surat->srt_asal_nama?></td>
        </tr>
        <tr>
          <td style="text-align:right;height:25px;"></td>
          <td colspan="2"><?= $surat->srt_asal_tanggal?></td>
        </tr>
        <tr>
